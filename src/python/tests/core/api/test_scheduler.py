...
class TestScheduler:
    ...
    def setup_method(self, method):
        # Remove data here to investigate failure reasons, should a test fail
        asyncio.get_event_loop().run_until_complete(remove_master_data())
        time.sleep(2)
